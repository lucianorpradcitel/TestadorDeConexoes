...
import {TesteConexaoController} from '../controllers/ConnectionController'
 ...
 */
router.post('/testar-conexoes', async (req: Request, res: Response): Promise<void> => {
     await TesteConexaoController.testarConexoes(req,res);
});
